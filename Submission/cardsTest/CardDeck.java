...
// This class represents an ArrayList of Card objects.
public class CardDeck {
    ...
    public Card getCard(int position) {
        // Returns the card object from deck at the index given and removes
        // that card object from the deck ArrayList.
    ...
    public Card viewCard(int position) {
        // Takes an int as input and gets the card at that position within the
        // deck.
